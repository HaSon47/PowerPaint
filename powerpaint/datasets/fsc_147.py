...
def build_index(train_root: str, max_num: int = None) -> List[SampleItem]:
    """
    train_root:
      train/img1/img.png
...
def build_index_val(val_txt: str, max_num: int = None) -> List[SampleItem]:
    items: List[SampleItem] = []
